...
public:
	...
	IpSpec():
		_isip(false),_isip4(false),	_isip6(false),_hasport(false),_hasip(false),_port(0),_ip("")
	{

	}
	IpSpec(const unsigned short& port, const string& ip="127.0.0.1", const bool& v4=true):
	...
	IpSpec& operator=(const IpSpec& other){
		if (&other != this){
			_hasip   = other._hasip;
			_hasport = other._hasport;
			_isip    = other._isip;
			_isip6   = other._isip6;
			_isip4   = other._isip4;
			_ip      = other._ip;
