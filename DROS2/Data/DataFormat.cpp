...
DataFormat::FormatList DataFormat::knownFormats = map_list_of
	...
	("DEFAULT_TBT",   DataFormat("DEFAULT_TBT",  TBT_FRAME_SIZE,   117440512ll, PT_TBT,   -1, 4 ))
	("DEFAULT_TBS",   DataFormat("DEFAULT_TBS",  TBS12_FRAME_SIZE, TBS12_DRATE, PT_TBS,   -1, 4 ))
	...
	("TBS_FILT_7",    DataFormat("TBS_FILT_7",   TBS4_FRAME_SIZE,   TBS4_DRATE,  PT_TBS,   -1, 4 ))
	("TBS_FILT_8",    DataFormat("TBS_FILT_8",   TBS8_FRAME_SIZE,   TBS8_DRATE,  PT_TBS,   -1, 4 ))
	("TBS_FILT_9",    DataFormat("TBS_FILT_9",   TBS12_FRAME_SIZE, TBS12_DRATE,  PT_TBS,   -1, 4 ))
