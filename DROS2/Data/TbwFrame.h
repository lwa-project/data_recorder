...
typedef struct __UnpackedTbwFrame12{
	TbwFrameHeader  header;
	UnpackedSample  samples_12bit[TBW_SAMPLES_PER_FRAME_12BIT];
} __attribute__((packed)) UnpackedTbwFrame12;


#define TBW_FRAME_SIZE (sizeof(TbwFrame))
#define TBW_TUNINGS            	2l
#define TBW_POLARIZATIONS     	2l
#define TBW_STREAMS            	(TBW_TUNINGS*TBW_POLARIZATIONS)
