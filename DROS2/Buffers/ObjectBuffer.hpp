...
public:
	...
	virtual T_REF   nextIn()const{SERIALIZE_ACCESS();return CAST_TO(GenericBuffer::nextIn());}
	virtual void    doneIn(T_REF obj){SERIALIZE_ACCESS();GenericBuffer::doneIn(CAST_FROM(obj));}
	virtual T_REF   nextOut()const{SERIALIZE_ACCESS();return CAST_TO(GenericBuffer::nextOut());}
	virtual void    doneOut(T_REF obj){SERIALIZE_ACCESS();GenericBuffer::doneOut(CAST_FROM(obj));}
	virtual T_REF   nextStage(int stage)const{SERIALIZE_ACCESS();return CAST_TO(GenericBuffer::nextStage(stage));}
	virtual void    doneStage(int stage, T_REF obj){SERIALIZE_ACCESS();GenericBuffer::doneStage(stage,CAST_FROM(obj));}
	virtual T_REF   peekStage(int stage, unsigned int peekAhead)const{SERIALIZE_ACCESS();return CAST_TO(GenericBuffer::peekStage(stage,peekAhead));}
	virtual void    reset(){
		SERIALIZE_ACCESS();
		__doOnDestroy();
		GenericBuffer::reset();
